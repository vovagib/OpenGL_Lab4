...
glm::vec3 refractPos(0.0f, 0.3f, 1.5f);
...
int main()
{
	...
	Shader light("lamp.vs", "lamp.frag");
	Shader shader("vertex.vs",
		"fragment.frag");
	Shader refract("refract.vs", "refract.frag");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		refract.use();
		refract.setVec4("objectColor", 1.0f, 0.5f, 0.31f, 0.3f);
		refract.setVec3("lightColor", 1.0f, 1.0f, 1.0f);
		refract.setVec3("lightPos", lightPos);
		refract.setVec3("viewPos", camera.Position);

		refract.setMat4("projection", projection);
		refract.setMat4("view", view);

		model = glm::mat4();
		model = glm::translate(model, refractPos);
		refract.setMat4("model", model);
